...
#define LORA3A22_UART_INDEX            (UART_4)              // 定义串口遥控器使用的串口
#define LORA3A22_UART_TX_PIN           (UART4_TX_P03)        // 遥控器接收机的RX引脚 连接单片机的TX引脚
#define LORA3A22_UART_RX_PIN           (UART4_RX_P02)        // 遥控器接收机的TX引脚 连接单片机的RX引脚
