...
typedef enum
{
    JOYSTICK_ADC_0_INDEX,
    JOYSTICK_ADC_1_INDEX,
    JOYSTICK_ADC_2_INDEX,
    JOYSTICK_ADC_3_INDEX,
    BATTERY_ADC_INDEX,
    // RNG_ADC_INDEX,

    ADC_INDEX_SUM,                                              // 非命令位，主要用来占位计数
}remote_adc_enum;

extern uint16 g_adc_reg_value[ADC_INDEX_SUM];
